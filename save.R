...
validated_results <- validated_results[order(as.numeric(validated_results$user_id)),]
...
# rmarkdown::render('./3_desc_stat_general.Rmd', output_file = './reports/3_desc_stat_general.html')
