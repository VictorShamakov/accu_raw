...
cor(ast_long.accuracy$miss_distance, ast_long.accuracy$velocity)
cor(ast_long.speed$miss_distance, ast_long.speed$velocity)
cor(ast_long$miss_distance, ast_long$velocity)
```
