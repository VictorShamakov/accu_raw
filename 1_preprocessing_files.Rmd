...
options(scipen = 10)
DATA_FROM_DB <- params$data_from_db #TRUE - from DB, FALSE - from files
...
```{r}
write_xlsx(accuracy_datasets$features, "./data/users/" %+% user_id %+% "/features.acc.xlsx")
write_xlsx(accuracy_datasets$ast_mt, "./data/users/" %+% user_id %+% "/ast_mt.acc.xlsx")
write_xlsx(accuracy_datasets$ast_long, "./data/users/" %+% user_id %+% "/ast_long.acc.xlsx")
write_xlsx(accuracy_datasets$ast_merged, "./data/users/" %+% user_id %+% "/ast_merged.acc.xlsx")
```
...
```{r}
write_xlsx(speed_datasets$features, "./data/users/" %+% user_id %+% "/features.spd.xlsx")
write_xlsx(speed_datasets$ast_mt, "./data/users/" %+% user_id %+% "/ast_mt.spd.xlsx")
write_xlsx(speed_datasets$ast_long, "./data/users/" %+% user_id %+% "/ast_long.spd.xlsx")
write_xlsx(speed_datasets$ast_merged, "./data/users/" %+% user_id %+% "/ast_merged.spd.xlsx")
```
...
### Задание на точность
```{r accuracy-alphabet, fig.height=4.5, fig.path='data/users/'%+% user_id %+% '/figures/', fig.show='hide', fig.width=9, out.width=830}
...
### Задание на скорость
```{r speed-alphabet, fig.height=4.5, fig.path='data/users/'%+% user_id %+% '/figures/', fig.show='hide', fig.width=9, out.width=830}
