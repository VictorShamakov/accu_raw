...
```{r eval=params$report, include=FALSE}
# rm(list=ls())
```
...
cat('<swiper-container class="mySwiper" keyboard="true" effect="fade" loop="true" speed=100>\n',
  paste0('<swiper-slide><img src="./figures/accuracy-alphabet-', 1:nrow(accuracy_datasets$ast_long), '.png"></swiper-slide>\n'),
'</swiper-container>')
```
...
```{r results='asis'}
cat('<swiper-container class="mySwiper" keyboard="true" effect="fade" loop="true" speed=100>\n',
  paste0('<swiper-slide><img src="./figures/speed-alphabet-', 1:nrow(speed_datasets$ast_long), '.png"></swiper-slide>\n'),
'</swiper-container>')
```
