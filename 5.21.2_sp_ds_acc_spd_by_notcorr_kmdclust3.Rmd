...
round(prop.table(table(df$notcorr_kmdclust3)) * 100, 1)
```
...
t_test_results <- pairwise.t.test(df.test$bfst_extraversion, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_extraversion, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_benevolence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_benevolence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_conscientiousness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_conscientiousness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_neuroticism, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_neuroticism, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_openness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_openness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_sociability, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_sociability, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_persistence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_persistence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_energy, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_energy, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_empathy, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_empathy, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_respect, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_respect, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_confidence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_confidence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_organization, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_organization, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_productivity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_productivity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_responsibility, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_responsibility, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_anxiety, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_anxiety, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_depression, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_depression, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_emotional_volatility, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_emotional_volatility, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_aesthetics, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_aesthetics, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_curiosity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_curiosity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$bfst_personal_creativity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$bfst_personal_creativity, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_all_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_all_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_all_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_all_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_static_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_static_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_static_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_static_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_animation_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_animation_mean, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_time_animation_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_time_animation_sd, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_right_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_right_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_right_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_right_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_right_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_right_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_error_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_error_all, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_error_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_error_static, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$mrot_error_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$mrot_error_animation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$vit_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$vit_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$vit_involvement, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$vit_involvement, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$vit_control, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$vit_control, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$vit_risk, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$vit_risk, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$lc, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$lc, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
#### Descriptive stat by notcorr_kmdclust3
```{r}
desc_by_group <- describeBy(df$soa_total, df$notcorr_kmdclust3, mat = T)
desc_by_group <- desc_by_group[order(desc_by_group$mean, decreasing = T),]
desc_by_group
```
...
plot_list <- draw_plots_continuous_by_cluster(df, var = df$soa_total, group = df$notcorr_kmdclust3, group_lab = "notcorr_kmdclust3", title = plot_title, legend_title = "notcorr_kmdclust3", x_lab = "Индекс самоорганизации", filename = NULL, binwidth = NULL, bins = 15, alpha = 0.5, angle = 90)
...
```{r results='asis'}
p1 <- ggplot(df, aes(sample = soa_total)) +  geom_qq(col=main_color) + geom_qq_line() + labs(title = "QQPlot - soa_total", tabname="QQPlot", filename=paste0(plot_title, "_QQplot")) + facet_wrap(". ~ notcorr_kmdclust3")
...
```{r}
aov_model <- aov(soa_total ~ notcorr_kmdclust3, data = df)
summary(aov_model)
```
...
```{r}
kruskal_test <- kruskal.test(soa_total ~ notcorr_kmdclust3, df)
kruskal_test
```

**Effect size**
```{r}
kruskal_effsize(df, soa_total ~ notcorr_kmdclust3)
```
...
t_test_results <- pairwise.t.test(df.test$soa_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
```{r}
pd = position_dodge(0.1)
ggplot(df, aes(x=notcorr_kmdclust3, y=soa_total, color=notcorr_kmdclust3)) +
  stat_summary(fun.data = mean_cl_boot, geom="errorbar", width=0.3, lwd=0.8, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="line", size=1, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="point", size=3, position = pd, pch = 15, alpha=alpha) + 
  theme(axis.text.x = element_text(angle = 90), legend.position = "none")
...
t_test_results <- pairwise.t.test(df.test$soa_planfulness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_planfulness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$soa_purposefulness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_purposefulness, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$soa_persistence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_persistence, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$soa_fixation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_fixation, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$soa_organization, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_organization, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$soa_present, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_present, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
#### Descriptive stat by notcorr_kmdclust3
```{r}
desc_by_group <- describeBy(df$soa_purposefulness_index, df$notcorr_kmdclust3, mat = T)
desc_by_group <- desc_by_group[order(desc_by_group$mean, decreasing = T),]
desc_by_group
```
...
plot_list <- draw_plots_continuous_by_cluster(df, var = df$soa_purposefulness_index, group = df$notcorr_kmdclust3, group_lab = "notcorr_kmdclust3", title = plot_title, legend_title = "notcorr_kmdclust3", x_lab = "Индекс целеустремленности", filename = NULL, binwidth = NULL, bins = 15, alpha = 0.5, angle = 90)
...
```{r results='asis'}
p1 <- ggplot(df, aes(sample = soa_purposefulness_index)) +  geom_qq(col=main_color) + geom_qq_line() + labs(title = "QQPlot - soa_purposefulness_index", tabname="QQPlot", filename=paste0(plot_title, "_QQplot")) + facet_wrap(". ~ notcorr_kmdclust3")
...
```{r}
aov_model <- aov(soa_purposefulness_index ~ notcorr_kmdclust3, data = df)
summary(aov_model)
```
...
```{r}
kruskal_test <- kruskal.test(soa_purposefulness_index ~ notcorr_kmdclust3, df)
kruskal_test
```

**Effect size**
```{r}
kruskal_effsize(df, soa_purposefulness_index ~ notcorr_kmdclust3)
```
...
t_test_results <- pairwise.t.test(df.test$soa_purposefulness_index, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_purposefulness_index, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
```{r}
pd = position_dodge(0.1)
ggplot(df, aes(x=notcorr_kmdclust3, y=soa_purposefulness_index, color=notcorr_kmdclust3)) +
  stat_summary(fun.data = mean_cl_boot, geom="errorbar", width=0.3, lwd=0.8, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="line", size=1, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="point", size=3, position = pd, pch = 15, alpha=alpha) + 
  theme(axis.text.x = element_text(angle = 90), legend.position = "none")
...
#### Descriptive stat by notcorr_kmdclust3
```{r}
desc_by_group <- describeBy(df$soa_rationality_index, df$notcorr_kmdclust3, mat = T)
desc_by_group <- desc_by_group[order(desc_by_group$mean, decreasing = T),]
desc_by_group
```
...
plot_list <- draw_plots_continuous_by_cluster(df, var = df$soa_rationality_index, group = df$notcorr_kmdclust3, group_lab = "notcorr_kmdclust3", title = plot_title, legend_title = "notcorr_kmdclust3", x_lab = "Индекс рациональности", filename = NULL, binwidth = NULL, bins = 15, alpha = 0.5, angle = 90)
...
```{r results='asis'}
p1 <- ggplot(df, aes(sample = soa_rationality_index)) +  geom_qq(col=main_color) + geom_qq_line() + labs(title = "QQPlot - soa_rationality_index", tabname="QQPlot", filename=paste0(plot_title, "_QQplot")) + facet_wrap(". ~ notcorr_kmdclust3")
...
```{r}
aov_model <- aov(soa_rationality_index ~ notcorr_kmdclust3, data = df)
summary(aov_model)
```
...
```{r}
kruskal_test <- kruskal.test(soa_rationality_index ~ notcorr_kmdclust3, df)
kruskal_test
```

**Effect size**
```{r}
kruskal_effsize(df, soa_rationality_index ~ notcorr_kmdclust3)
```
...
t_test_results <- pairwise.t.test(df.test$soa_rationality_index, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$soa_rationality_index, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
```{r}
pd = position_dodge(0.1)
ggplot(df, aes(x=notcorr_kmdclust3, y=soa_rationality_index, color=notcorr_kmdclust3)) +
  stat_summary(fun.data = mean_cl_boot, geom="errorbar", width=0.3, lwd=0.8, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="line", size=1, position=pd, alpha=alpha) +
  stat_summary(fun.data = mean_cl_boot, geom="point", size=3, position = pd, pch = 15, alpha=alpha) + 
  theme(axis.text.x = element_text(angle = 90), legend.position = "none")
...
t_test_results <- pairwise.t.test(df.test$kot_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_total, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_verbal, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_verbal, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_number, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_number, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_attention, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_attention, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_spatial, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_spatial, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_general, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_general, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
t_test_results <- pairwise.t.test(df.test$kot_logic, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");t_test_results
wilcox_test_results <- pairwise.wilcox.test(df.test$kot_logic, df.test$notcorr_kmdclust3, p.adjust.method = "bonferroni");wilcox_test_results
```
...
if (length(sign_differences) != 0) {
  df.sign_differences <- data.frame(sign_differences, analysis="notcorr_kmdclust3", filename = "5.21.2_sp_ds_acc_spd_by_notcorr_kmdclust3")
} else {
