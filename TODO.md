...
- [ ] посмотреть размах между показателями (время, точность, скорость, амплитуда) на точность и на скорость. Это дополнительные характеристики.
...
- [ ] Добавить кластер кликеров.
- [ ] Взять респондентов с высокой психодиагностической метрикой и сравнить их движений между собой.
- [ ] Добавить соотношения кластеров
