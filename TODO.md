...
- [ ] Статистика
  ...
  - [ ] Сделать описательную статистику и кластерный анализ только для этапа на точность.
  - [ ] Сделать описательную статистику и кластерный анализ только для этапа на скорость
