...
- [ ] Кластеризация для двух этапов

  - [ ] Широкий формат данных для двух этапов
  - [ ] Разница между до и после (Стандартизовать после нахождения разницы)
  - [ ] Рассмотреть переход в кластеры на этапе до и после. То есть можно использовать результаты кластеризации на первом этапе для последующей кластеризации.
  - [ ] Визуализировать графики изменения по кластерам, тепловые карты
...
- [x] Выделить в кластерном анализе выбросы, проанализировать их отдельно и исключить из общей выборки. 
  - [x] Добавить 7 кластеров
  - [x] Вернуть снова до количества кластеров, когда в кластере не менее 30 респондентов

- [ ] Провести факторный анализ и выделить новый вариант кластеризации.

- [ ] Попробовать PCA

- [ ] Добавить время реакции. Время после появления мишени до начала действия. Или паузы и есть время реакции

- [ ] Нарисовать график-портрет для пользователя, а также для всего кластера (средние)

![image-20250725151627848](/home/master/.config/Typora/typora-user-images/image-20250725151627848.png)
