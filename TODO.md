...
- [ ] Кластеризация для двух этапов
  ...
  - [ ] Рассмотреть переход в кластеры на этапе до и после. То есть можно использовать результаты кластеризации на первом и втором этапах для последующей общей кластеризации.
  - [ ] Визуализировать графики изменения по кластерам, тепловые карты

- [ ] Кластеризовать с логарифмированием
...
- [x] Нарисовать график-портрет для пользователя, а также для всего кластера (средние)
